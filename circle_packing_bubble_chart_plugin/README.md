# GoodData.UI Dashboard Plugin - Circle Packing Bubble Chart

This plugin replaces all bubble charts with a custom [d3.js](https://d3js.org/) [circle packing bubble chart](https://observablehq.com/@d3/bubble-chart).

## How to make it work

1. Clone this repository
1. Navigate to `circle_packing_bubble_chart_plugin`
1. Provide backend, workspace and dashboard in `.env`
1. Rename `.env.secrets` and provide your preferred way of authentication
...
2.  Develop your plugin code in `src/dp_circle_packing_bubble_chart_plugin`

    The `src/dp_circle_packing_bubble_chart_plugin/Plugin.jsx` is the main plugin file where you have to register all
    your custom content. However, you can create as many new files as you want under the `src/dp_circle_packing_bubble_chart_plugin`
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_circle_packing_bubble_chart_plugin.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_circle_packing_bubble_chart_plugin](./src/dp_circle_packing_bubble_chart_plugin/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_circle_packing_bubble_chart_plugin](./src/dp_circle_packing_bubble_chart_plugin) directory.

The [src/dp_circle_packing_bubble_chart_plugin\_engine](./src/dp_circle_packing_bubble_chart_plugin_engine) and [src/dp_circle_packing_bubble_chart_plugin\_entry](./src/dp_circle_packing_bubble_chart_plugin_entry) directories contain essential plugin boilerplate.
...
You can modify minEngineVersion and maxEngineVersion properties in `src/dp_circle_packing_bubble_chart_plugin\_entry/index`.
