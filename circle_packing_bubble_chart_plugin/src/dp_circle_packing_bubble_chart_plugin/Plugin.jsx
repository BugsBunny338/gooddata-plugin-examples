...
import entryPoint from "../dp_circle_packing_bubble_chart_plugin_entry";
import CirclePackingBubbleChart from "./CirclePackingBubbleChart";
...
export class Plugin extends DashboardPluginV1 {
    ...
    register(_ctx, customize, handlers) {
        customize.insightWidgets().withCustomProvider(insight => {
            if (insightVisualizationUrl(insight) === "local:bubble") {
              return CirclePackingBubbleChart;
            }
            return undefined;
        });
